...
Laravel supports verifying email addresses out of the box. This package adds support for verifying new email addresses, for example when a user decides to update the email address. It updates the user's email address after it has been verified. Requires Laravel 6.0 and PHP 7.2 or higher.
